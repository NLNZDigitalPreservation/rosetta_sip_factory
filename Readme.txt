...
1. For rosetta_sip_factory (sip_builder.py) new parameter "exclude_file_characteristics" was added to build_single_file_sip  and build_sip functions.
test_build_sip_with_exclude_file_characteristics() test was added.
...
2. For mets_dnx (factory.py) new parameter "exclude_file_characteristics" was added to build_single_file_mets  and build_mets functions.
and also this logic which removing tags.
            ...
            general_file_characteristics = [{
                ...
                'label': file_label}]
            for file_char in exclude_file_characteristics:
